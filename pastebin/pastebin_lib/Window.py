...
import logging
logger = logging.getLogger('pastebin_lib')

from . helpers import get_builder, show_uri, get_help_uri

# This class is meant to be subclassed by PastebinWindow.  It provides
...
class Window(Gtk.Window):
    ...
    def __new__(cls):
        ...
        Returns a fully instantiated BasePastebinWindow object.
        """
        builder = get_builder('PastebinWindow')
        new_object = builder.get_object("pastebin_window")
    ...
    def finish_initializing(self, builder):
        ...
        and creating a PastebinWindow object with it in order to finish
        initializing the start of the new PastebinWindow instance.
        """
        ...
        self.settings = Gio.Settings("net.launchpad.pastebin")
        ...
        try:
            ...
            LaunchpadIntegration.set_sourcepackagename('pastebin')
        except ImportError:
            pass
        ...
        try:
            from pastebin import indicator
    ...
    def on_mnu_about_activate(self, widget, data=None):
        """Display the about box for pastebin."""
    ...
    def on_mnu_preferences_activate(self, widget, data=None):
        """Display the preferences window for pastebin."""
    ...
    def on_mnu_close_activate(self, widget, data=None):
        """Signal handler for closing the PastebinWindow."""
        self.destroy()

    def on_destroy(self, widget, data=None):
        """Called when the PastebinWindow is closed."""
